...
const Footer = () => {
    return (
        <footer className="bg-neutral p-2 mt-20 text-neutral-content">
        <div className="footer  p-10">
        <aside>
          <img src={logo} className="w-10 h-10 rounded-2xl" alt="" />
          <p>Asset Management Ltd.<br/>Providing reliable tech since 1992</p>
        </aside> 
        <nav>
    <header className="footer-title">Services</header> 
    <a className="link link-hover">Bitcoin</a> 
    <a className="link link-hover">Ether</a> 
    <a className="link link-hover">Litecoin</a> 
    ...
    <p>Copyright © 2023 - All right reserved by Asset Management</p>
  </div>
      </footer>
    );
};
